...
* hacker_rank_ss.png: Proof of the completed coding task and score.  
* google_form_ss.png: Screenshot of the quiz layout.  
* responses_for_google_form_ss.png: Screenshot of the linked Google Sheet for data collection.
